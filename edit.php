...
$filename3 = $_FILES["image3"]["name"];
 ...
 $update="UPDATE info SET name='".$_POST['name']."', father_name='".$_POST['fname']."', mother_name='".$_POST['mname']."', gender='".$_POST['gender']."', dob='".$_POST['dob']."', email='".$_POST['email']."',mobile='".$_POST['mobile']."', p_house='".$_POST['p_flat']."', p_street='".$_POST['p_street']."', p_city='".$_POST['p_city']."', p_district='".$_POST['p_district']."', p_state='".$_POST['p_state']."', p_pin='".$_POST['p_pincode']."', p_country='".$_POST['p_country']."', m_house='".$_POST['m_flat']."', m_street='".$_POST['m_street']."', m_city='".$_POST['m_city']."', m_district='".$_POST['m_district']."', m_state='".$_POST['m_state']."', m_pin='".$_POST['m_pincode']."', m_country='".$_POST['m_country']."', document='".$_POST['document']."', document_no='".$_POST['docu_no']."', debarred='".$_POST['debarred']."', category='".$_POST['Category']."', ssc_exam='".$ssc_data."', hsc_exam='".$hsc_data."', graduation='".$gra_data."', pg_graduation='".$pg_data."', photograph='".$filename."', signature='".$filename1."', id_proof='".$filename2."', ad_proof='".$filename3."', qualification_proof='".$filename4."' where id='".$_GET['id']."'";
...
<div class="container">
    ...
    <section>
            <div class="wizard" >
                <h1 id="ttf">Edit Application Form </h1> <a href="view_data.php" ><span class=" btn btn-lg btn-primary glyphicon glyphicon-home" style="float: right;" aria-hidden="true"></span> </a>
